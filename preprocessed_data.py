...
def remove_punctuation(s):
        ...
        replace_punctuation = str.maketrans(punc, ' '*len(punc))
...
def shuffle_data(content, summary, query, name):
	...
	f1 = open(content, "r", encoding = "utf8")
	f2 = open(summary, "r", encoding = "utf8")
	f3 = open(query, "r", encoding = "utf8")
	...
	combine = list(zip(l1,l2,l3))
	#print combine	
	random.shuffle(combine)
	#print combine

	print(name)
	with open(name + "_content", "w", encoding = "utf8") as w1, open(name+"_summary", "w") as w2, open(name+"_query", "w", encoding = "utf8") as w3:
